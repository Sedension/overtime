<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_release.aspx.cs" Inherits="release" %>
        ...
        <div class="new">
            ...
            <div style="height: 50px; width: 100%; margin-top: 10%;">
                <div class="table-left">
                    <asp:Button ID="Button2" runat="server" Text="发布" CssClass="layui-btn layui-btn-primary layui-btn-sm" OnClick="Button2_Click" />
                </div>
                <div class="table-right-1">
                    <asp:Button ID="Button1" runat="server" Text="重置" CssClass="layui-btn layui-btn-primary layui-btn-sm" OnClick="Button1_Click1" />
                </div>
            </div>
        </div>
    </form>
